...
--##########################################################################
PRINT '1) Rimozione oggetti esistenti'
GO

IF EXISTS (SELECT * FROM sysobjects WHERE id=OBJECT_ID('GALA_CB.CB_EntitaCampi'))
BEGIN 
...
IF EXISTS (SELECT * FROM sysobjects WHERE id=OBJECT_ID('GALA_CB.CB_EntitaCampiValoriAmmessi')) 
	ALTER TABLE GALA_CB.CB_EntitaCampiValoriAmmessi DROP CONSTRAINT FKCB_EntitaC134717;

IF EXISTS (SELECT * FROM sysobjects WHERE id=OBJECT_ID('GALA_CB.CB_Elaborazioni')) 
BEGIN
...
IF EXISTS (SELECT * FROM sysobjects WHERE id=OBJECT_ID('GALA_CB.CB_Entita'))
DROP TABLE GALA_CB.CB_Entita;

IF EXISTS (SELECT * FROM sysobjects WHERE id=OBJECT_ID('GALA_CB.CB_EntitaCampi'))
DROP TABLE GALA_CB.CB_EntitaCampi;

IF EXISTS (SELECT * FROM sysobjects WHERE id=OBJECT_ID('GALA_CB.CB_TipoCampo'))
...
IF EXISTS (SELECT * FROM sysobjects WHERE id=OBJECT_ID('GALA_CB.CB_TipologiaElaborazione'))
DROP TABLE GALA_CB.CB_TipologiaElaborazione;

IF EXISTS (SELECT * FROM sysobjects WHERE id=OBJECT_ID('GALA_CB.CB_Esito'))
...
--##########################################################################
PRINT '2) Creazione tabella CB_Entita'
GO
...
PRINT '3) Creazione Tabella CB_EntitaCampi'
GO
...
GO
--##########################################################################
PRINT '4) Creazione Tabella CB_TipoCampo'
GO
...
PRINT '5) Creazione Tabella CB_EntitaCampiValoriAmmessi'
GO
...
PRINT '6) Creazione Tabella CB_Elaborazioni'
GO
...
PRINT '7) Creazione Tabella CB_TipologiaElaborazione'
GO
...
PRINT '8) Creazione Tabella CB_Esito'
GO
...
PRINT '9) Aggiunta constraint foreign key tabelle'
GO
...
PRINT '10) popolamento tabella CB_Entita'
GO

/* ISTRUZIONI SQL SENZA GO */
SET IDENTITY_INSERT GALA_CB.CB_Entita ON;
INSERT INTO GALA_CB.CB_Entita(id, Nome, NomeTabellaDestinazione, ProceduraEstrazione, OrdineElaborazione, Attivo) VALUES (1001, 'Anagrafica Clienti', 'GALA_ANAGRAFICA_CLIENTI', 'GALA_CB.CB_Sp_GetAnagraficaClienti', 2, 1);
INSERT INTO GALA_CB.CB_Entita(id, Nome, NomeTabellaDestinazione, ProceduraEstrazione, OrdineElaborazione, Attivo) VALUES (1002, 'Anagrafica Contratti', 'GALA_ANAGRAFICA_CONTRATTI', 'GALA_CB.CB_Sp_GetAnagraficaContratti', 1, 1);
INSERT INTO GALA_CB.CB_Entita(id, Nome, NomeTabellaDestinazione, ProceduraEstrazione, OrdineElaborazione, Attivo) VALUES (1003, 'Dati POD PDR', 'GALA_POD_PDR', 'GALA_CB.CB_Sp_GetPodPdr', 4, 1);
INSERT INTO GALA_CB.CB_Entita(id, Nome, NomeTabellaDestinazione, ProceduraEstrazione, OrdineElaborazione, Attivo) VALUES (1004, 'Anagrafica Movimenti', 'GALA_ANAGRAFICA_MOVIMENTI', 'GALA_CB.CB_Sp_GetAnagraficaMovimenti', 5, 1);
...
PRINT '11) popolamento tabella CB_TipoCampo'
GO
...
PRINT '12) popolamento tabella CB_EntitaCampi'
GO
...
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (83, 1001, 'ORIGINE_CLIENTE', 'ORIGINE_CLIENTE', 'ORIGINE DEL CLIENTE', 0, 100, 20, 34, 1);
...
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (162, 1004,'IMPONIBILE','IMPONIBILE','IMPONIBILE',0,20,40,13,1)
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (163, 1004, 'ID_CAUSALE', 'ID_CAUSALE', 'ID CAUSALE', 1, 10, 20, 13, 1);
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (164, 1004, 'DESCR_CAUSALE', 'DESCR_CAUSALE', 'DESCRIZIONE CAUSALE', 1, 50, 20, 14, 1);
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (165, 1004, 'ID_PAG_MOD', 'ID_PAG_MOD', 'ID MODALITA PAGAMENTO', 0, 10, 20, 15, 1);
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (166, 1004, 'DESCR_PAG_MOD', 'DESCR_PAG_MOD', 'DESCRIZIONE MODALITA PAGAMENTO', 0, 50, 20, 16, 1);
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (167, 1004, 'ID_PAG_TER', 'ID_PAG_TER', 'ID PAG TER', 0, 10, 20, 17, 1);
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (168, 1004, 'DESCR_PAG_TER', 'DESCR_PAG_TER', 'DESCR PAG TER', 0, 50, 20, 18, 1);
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (169, 1004, 'COMMODITY', 'COMMODITY', 'COMMODITY', 0, 10, 20, 19, 1);
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (170, 1004, 'CODICE_PARTITA', 'CODICE_PARTITA', 'CODICE PARTITA', 0, 50, 20, 20, 1);
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (171, 1004, 'FACTOR', 'FACTOR', 'FACTOR', 0, 50, 20, 21, 1);
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (172, 1004, 'TIPOLOGIA_FATTURA', 'TIPOLOGIA_FATTURA', 'TIPOLOGIA FATTURA', 0, 100, 20, 22, 1);
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (173, 1004, 'DESSCRIZIONE_TIPOLOGIA_FATTURA', 'DESSCRIZIONE_TIPOLOGIA_FATTURA', 'DESCRIZIONE TIPOLOGIA FATTURA', 0, 200, 20, 23, 1);
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (174, 1004, 'URL', 'URL', 'URL', 0, 2048, 20, 24, 1);
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (175, 1004, 'ID_STATO', 'ID_STATO', 'ID_STATO', 0, 20, 10, 25, 1);
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (176, 1004, 'ID_FATTURA', 'ID_FATTURA', 'ID_FATTURA', 0, 20, 10, 26, 1);
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (177, 1004, 'DATA_SCAD_RICALCOLATA', 'DATA_SCAD_RICALCOLATA', 'Data Scadenza Ricalcolata da SDI', 0, 30, 30, 27, 1);

INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (180,1007,'ID_AZIENDA','ID_AZIENDA','Sempre valorizzato con IT10',1,10,20,1,1);
INSERT INTO GALA_CB.CB_EntitaCampi(id, id_Entita, NomeCampoOrigine, NomeCampoDestinazione, Descrizione, Obbligatorio, Lunghezza, id_TipoCampo, OrdineEstrazione, Attivo) VALUES (181,1007,'ID_CLIENTE','ID_CLIENTE','ID_ANAGRAFICA',1,30,20,2,1);
...
PRINT '13) popolamento tabella CB_EntitaCampiValoriAmmessi'
GO
...
PRINT '14) popolamento tabella CB_TipologiaElaborazione'
GO
...
PRINT '15) popolamento tabella CB_Esito'
GO
